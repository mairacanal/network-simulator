...
class DataLink:public Layer{
    public:
        /**
         * Faz o envio de um frame(bitset), utilizando algoritmos de alteracao para 
         manutencao da consistencia nele
    ...
    private:
        ...
        **/
        ...
        /**
         * Subrotina de manutencao de integridade utilizando polinomios e o algoritmo
         crc32
         * @param frame bitset a ser manipulado
        **/
